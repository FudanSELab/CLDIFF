...
public class LinkStatement2Member {
    ...
    public static void checkStmtMethodAssociation(ChangeEntityData changeEntityData, ChangeEntity stmt,ChangeEntity method){
    ...
    public static void checkStmtFieldAssociation(ChangeEntityData changeEntityData, ChangeEntity stmt,ChangeEntity field){
