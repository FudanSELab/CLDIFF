...
public class MiningActionBean {
	...
	/**
	 * fatherTypeTofatherMap存每一种类型的father的list， 由这个list去其他两个map找对应的action和变化的类型
	 */
	...
	// List<ITree> mList =
	// this.fatherTypeToFathersMap.get(ActionConstants.METHODINVOCATION);
	// mList.add(parent);
	// }else{
	...
	// List<ITree> mList =
	// this.fatherTypeToFathersMap.get(ActionConstants.IfPredicate);
	// mList.add(parent);
	// }else{
	// List<ITree> mList = new ArrayList<ITree>();
	// mList.add(parent);
	...
	// List<ITree> mList =
	// this.fatherTypeToFathersMap.get(ActionConstants.ForPredicate);
	// mList.add(parent);
	// }else{
	// List<ITree> mList = new ArrayList<ITree>();
	// mList.add(parent);
	...
	// addParentAndAction(parent,a);
	// }
	// public void mapMethodInvocationAndActions(ITree parent,List<Action>
	// mList){
	...
	// * @param mActionList
	// */
	// public void mapMethodSignatureAction(ITree fafafather, List<Action>
	// mActionList) {
