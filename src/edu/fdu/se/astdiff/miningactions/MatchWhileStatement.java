...
public class MatchWhileStatement {
    public static HighLevelOperationBean matchWhileStatement(FindPattern fp, Action a, String nodeType){
    ...
    public static HighLevelOperationBean matchDoStatement(FindPattern fp, Action a, String nodeType){
