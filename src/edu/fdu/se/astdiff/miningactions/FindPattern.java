...
public class FindPattern {
	...
	public void printHighLevelOperationBeanList(List<HighLevelOperationBean> mHighLevelOperationBeanList) {
		if (mHighLevelOperationBeanList.isEmpty()) {
			...
			for (HighLevelOperationBean operationBean : mHighLevelOperationBeanList) {
				...
				if (operationBean.curAction instanceof Insert) {
					treeContext = this.mMiningActionBean.mDstTree;
				} else {
					treeContext = this.mMiningActionBean.mSrcTree;
				}
	...
	public void find() {
		...
		this.findUpdate();
		this.findMove();
		this.printHighLevelOperationBeanList(mHighLevelOperationBeanList);
	}
